package com.red.dargon.nsbaselibrary.utils.device;
...
public final class PhoneUtils {
     ...
     * 判断运营商
     */
    public static String checkPhoneFromCarrieroperator(String phone) {
        String head1 = "";
        String head2 = "";
...
//        try {
//            providerName = URLEncoder.encode("" + providerName, "UTF-8");
//        } catch (UnsupportedEncodingException e) {
//            e.printStackTrace();
//        }
//        Log.e("TAG_IMSI", "==== 当前卡为：" + providerName);
        return providerName;
    }
}
